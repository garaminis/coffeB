...
<body>
    ...
    <div class="email_container">
        ...
        <div class="email_box">
            <!-- 이메일 입력창 -->
            <input type="text" id="input_email" class="input input_email" placeholder="인증할 이메일을 입력해주세요.">
        ...
        <div class="misspell_box">
            ...
            <button class="email_change">이메일변경</button>
        </div>
    </div>
    ...
    <div class="auth_container">
        ...
        <div class="auth_box">
            ...
            <div class="input_container">
                <!-- 입력창 -->
                <input type="text" id="auth_input" class="input input_auth" placeholder="받은 인증코드를 입력해주세요.">
                <!-- 유효시간 타이머 -->
        ...
        <!-- 인증코드 재발송 -->
        <div class="ReRFCBox">
            <span>인증코드를 받지 못하셨나요?</span><br><br>
    ...
    <script>
        ...
        window.onload = function(event){
            ...
            RFCBtn.onclick = function(e){
                ...
                // 발송된 코드 
                //ResponseCode = "123456";
                ResponseCode = generateRandomSixDigitNumber();
                //확인용 콘솔
				console.log(ResponseCode);
 				console.log($("#input_email").val());
                
				sendMail(ResponseCode,$("#input_email").val());
                // 화면 처리
        ...
        function generateRandomSixDigitNumber() {
        	  // 100000부터 999999 사이의 랜덤한 정수를 생성합니다.
        	  const randomNumber = Math.floor(Math.random() * 900000) + 100000;
        	  // 숫자를 문자열로 변환합니다.
        	  const randomNumberAsString = String(randomNumber);
        	  // 만약 숫자가 6자리가 아니라면 앞에 0을 추가하여 6자리로 만듭니다.
        	  return randomNumberAsString.padStart(6, '0');
        	}
        function sendMail(codenum, Email){
            //인증번호와 이메일을 받아 작동하는 ajax
            $.ajax({
                type: 'post',
                url: '/mail/send',
                data: {code: codenum, mail: Email},
                dataType: 'text',
